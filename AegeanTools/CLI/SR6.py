...
def main():
    ...
    logger.info(f"This is SR6 {__version__}-({__date__})")

    if not os.path.exists(results.infile):
        logger.error(f"{results.infile} does not exist")
        return 1
